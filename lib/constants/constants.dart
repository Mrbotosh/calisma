...
class Sabitler{
  ...
  static  BorderRadius borderRadiuskullan=BorderRadius.circular(16);
  static final TextStyle textStyle=GoogleFonts.quicksand(
    fontSize:16,fontWeight: FontWeight.w600,color:anarenk,
  );
  static final TextStyle ortalamaStyle=GoogleFonts.quicksand(
    fontSize:55,fontWeight: FontWeight.w800,color:anarenk,
  );
  static final Widget listeOrtasi=Text("Lütfen Ders Giriniz");
